      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-4">
            ...
            <span className="text-sm text-blue-400 font-medium">About WeeStox</span>
          </div>
        ...
        <div className="card mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Halal Stock Screening</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Live Metal Prices</h3>
                <p className="text-gray-400 text-sm">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">IPO Analysis</h3>
                <p className="text-gray-400 text-sm">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Zakat Calculator</h3>
                <p className="text-gray-400 text-sm">
        ...
        {/* CTA */}
        <div className="card text-center bg-gradient-to-br from-blue-950 to-gray-900 border-blue-500/50">
