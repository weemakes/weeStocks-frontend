...
export default function HeroScannerPreview() {
  ...
  return (
    ...
    >
      ...
      <div className="hidden sm:flex items-center gap-2 absolute -top-4 -right-3 z-30 bg-white/95 dark:bg-slate-900/90 border border-emerald-500/30 px-3.5 py-1.5 rounded-full shadow-xl shadow-emerald-500/10 dark:shadow-emerald-950/40 animate-float backdrop-blur-md">
        <span className="w-2 h-2 rounded-full bg-emerald-500 dark:bg-emerald-400 animate-ping" />
        <Flame className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400" />
        <span className="text-[11px] font-bold text-slate-800 dark:text-slate-100">
          IPO GMP Alert: <span className="text-emerald-600 dark:text-emerald-400 font-extrabold">+38.5% Gain</span>
        </span>
      </div>
      ...
      <div className="hidden sm:flex items-center gap-2 absolute -bottom-4 -left-3 z-30 bg-white/95 dark:bg-slate-900/90 border border-sky-500/30 px-3.5 py-1.5 rounded-full shadow-xl shadow-sky-500/10 dark:shadow-sky-950/40 animate-float-delayed backdrop-blur-md">
        ...
        <span className="text-[11px] font-bold text-slate-700 dark:text-slate-200">
          AAOIFI Standard 21 &bull; <span className="text-sky-600 dark:text-sky-400">Zero-Debt Screening</span>
        </span>
      </div>
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <h3 className="text-lg md:text-xl font-bold text-slate-900 dark:text-slate-100">{stock.name}</h3>
