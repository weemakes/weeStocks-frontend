...
export default function Navigation() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-slate-950/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
      ...
      <div className="bg-slate-100/90 dark:bg-slate-900/90 border-b border-slate-200/80 dark:border-slate-800/80 text-[11px] py-1 px-3 overflow-hidden select-none">
      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1.5">
                ...
                <span className="px-1 py-0.2 bg-sky-500/15 text-sky-600 dark:text-sky-400 text-[9px] font-bold rounded uppercase">
                  Terminal
                </span>
              </div>
              <span className="text-[9px] text-slate-500 dark:text-slate-400 -mt-0.5 tracking-tight hidden sm:inline">
          ...
          <div className="hidden md:flex items-center gap-1 text-sm font-medium">
            <Link
              ...
              className={`px-3 py-1.5 rounded-lg transition-colors ${
                isActive('/') && pathname === '/'
                  ? 'text-sky-600 dark:text-sky-400 bg-slate-100 dark:bg-slate-900 font-semibold'
                  : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-900/60'
              }`}
            >
              Home
            </Link>
            ...
            >
              ...
              >
                <span>Stocks</span>
                <span className="px-1 py-0.2 text-[9px] bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 font-bold rounded">
                  Screener
                </span>
                  ...
                  <div className="w-56 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-2xl p-2 text-xs divide-y divide-slate-100 dark:divide-slate-800/60 animate-fade-in">
                    <div className="pb-1.5 space-y-0.5">
                      ...
                      >
                        ...
                        <div className="text-[10px] text-slate-500 dark:text-slate-400">100% Shariah compliant equities</div>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <div className="text-[10px] text-slate-500 dark:text-slate-400">Net-cash pristine balance sheets</div>
                      </Link>
                    </div>
                    <div className="pt-1.5 space-y-0.5">
                      ...
                      >
                        ...
                        <div className="text-[10px] text-slate-500 dark:text-slate-400">Bluechip halal performers</div>
                      </Link>
                    </div>
                  </div>
                </div>
            ...
            {/* Metals Dropdown (Default City routing) */}
            <div
              className="relative"
                ...
                <div className="absolute top-full left-0 pt-1 z-30">
                  <div className="w-48 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-2xl p-2 text-xs space-y-0.5 animate-fade-in">
                    ...
                    >
                      ...
                      <span className="text-[10px] text-amber-500 dark:text-amber-400 font-bold">Live</span>
                    </Link>
                    <Link
                      href="/silver"
            ...
            >
              <span>IPOs</span>
              <span className="px-1.5 py-0.2 text-[9px] bg-rose-500/20 text-rose-600 dark:text-rose-400 font-bold rounded">
                GMP Live
              </span>
            </Link>
          ...
          <div className="hidden md:flex items-center gap-2.5">
            <Link
              href="/stocks"
              className="flex items-center gap-2 px-3 py-1.5 bg-slate-100 dark:bg-slate-900 hover:bg-slate-200/70 dark:hover:bg-slate-850 border border-slate-200 dark:border-slate-800 rounded-lg text-xs text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 transition-all"
            >
              <Search className="w-3.5 h-3.5" />
              <span>Search stocks...</span>
              <kbd className="px-1.5 py-0.5 text-[9px] font-bold text-slate-500 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded">
                ⌘K
              </kbd>
            </Link>
          ...
          <div className="flex md:hidden items-center gap-1.5">
            <ThemeToggle />
            <button
              className="p-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-900 rounded-lg transition-colors"
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-3 border-t border-slate-200 dark:border-slate-800 animate-fade-in space-y-1">
            <Link
              href="/"
            ...
            <Link
              href="/stocks"
              onClick={() => setIsMobileMenuOpen(false)}
              className="flex items-center justify-between px-3 py-2 rounded-lg text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-900"
            >
