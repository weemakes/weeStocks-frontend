...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800/80 py-6 md:py-7 text-xs text-slate-600 dark:text-slate-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8 mb-5">
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-1.5">
              <li>
                <Link href="/stocks" className="hover:text-sky-600 dark:hover:text-sky-400 transition-colors">
                  Halal Stock Screener
                </Link>
              </li>
              <li>
                <Link href="/stocks?filter=zero_debt" className="hover:text-sky-600 dark:hover:text-sky-400 transition-colors">
                  Zero-Debt Giants
                </Link>
              </li>
              <li>
                <Link href="/stocks?filter=nifty50" className="hover:text-sky-600 dark:hover:text-sky-400 transition-colors">
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-1.5">
              <li>
                <Link href="/gold" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                  Gold Rates Today (24K/22K)
                </Link>
              </li>
              <li>
                <Link href="/silver" className="hover:text-slate-900 dark:hover:text-slate-200 transition-colors">
                  Silver Prices (1kg / 10g)
                </Link>
              </li>
              <li>
                <Link href="/platinum" className="hover:text-sky-600 dark:hover:text-sky-400 transition-colors">
                  Platinum Market Rates
                </Link>
              </li>
              <li>
                <Link href="/ipo" className="hover:text-sky-600 dark:hover:text-sky-400 transition-colors flex items-center gap-1">
                  Live IPO GMP & Status
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-1.5">
              <li>
                <Link href="/zakat" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                  Zakat Calculator
                </Link>
              </li>
              <li>
              ...
              <li>
                <a href="mailto:care@weestox.com" className="hover:text-sky-600 dark:hover:text-sky-400 transition-colors flex items-center gap-1">
                  Support & Contact
