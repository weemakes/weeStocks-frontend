...
export default function StockFilterBar({
  ...
  return (
    <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-3 md:p-4 mb-5 shadow-lg space-y-3.5">
      ...
      <div className="flex flex-col md:flex-row gap-2.5 items-stretch md:items-center justify-between">
        ...
        <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap justify-between md:justify-end">
          ...
          <select
            ...
            className="px-3 py-1.5 bg-slate-950/80 border border-slate-800 rounded-lg text-xs font-medium text-slate-300 focus:outline-none focus:border-sky-500"
          >
      ...
      <div className="flex items-center justify-between gap-3 pt-2 border-t border-slate-800/80 overflow-x-auto no-scrollbar">
        ...
        <div className="text-xs text-slate-400 shrink-0 font-medium tabular-nums pl-2">
          Showing <span className="text-slate-100 font-bold">{totalFilteredCount}</span> results
        </div>
      </div>
    </div>
  );
