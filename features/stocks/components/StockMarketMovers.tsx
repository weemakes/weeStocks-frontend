...
export default function StockMarketMovers({ country, onSelectStock }: StockMarketMoversProps) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-sm mb-6 transition-colors">
      ...
      {/* Movers Cards Strip */}
      {loading ? (
        <div className="h-20 flex items-center justify-center text-xs text-slate-500 dark:text-slate-400 gap-2">
          ...
          {movers.map((m) => {
            ...
            return (
              <div
                ...
                className="bg-slate-50 dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800/80 hover:border-slate-300 dark:hover:border-slate-700 p-2.5 rounded-xl cursor-pointer transition-all hover:bg-slate-100 dark:hover:bg-slate-800/40 group"
              >
                <div>
                ...
                <div className="flex items-baseline justify-between gap-1 pt-1.5 border-t border-slate-200 dark:border-slate-800/60">
